...
?>
<?php
$dental_insight_post_option = get_theme_mod( 'dental_insight_post_option','two_column');
if($dental_insight_post_option == 'two_column'){ ?>
...
<div id="sidebar" class="col-lg-4 col-md-4"><?php dynamic_sidebar('sidebar-1'); ?></div>
<?php }
if($dental_insight_post_option == 'grid_post'){ ?>
<div class="content_area col-lg-12 col-md-12">
    <section id="post_section">
        <div class="row">
            <?php
